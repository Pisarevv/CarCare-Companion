...
namespace CarCare_Companion.Infrastructure.Migrations
{
    ...
    [Migration("20230725184704_EditRefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarCare_Companion.Infrastructure.Data.Models.Ads.CarouselAdModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("2256a67b-2a9c-4ba9-be4f-42cf349b7e9a"),
                        ...
                        new
                        {
                            Id = new Guid("029eac54-b4cd-4188-8de9-21044cb9855f"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("e92ec316-1716-4d36-9a04-4dd5a7d5a0ce"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("bacef05a-1270-4302-ba4f-6672d5c8f6e0"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = new Guid("408ef425-19f4-43a0-891a-2b1080df4c36"),
                            CreatedOn = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("CarCare_Companion.Infrastructure.Data.Models.Identity.UserRefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CarCare_Companion.Infrastructure.Data.Models.Identity.UserRefreshToken", b =>
                {
                    b.HasOne("CarCare_Companion.Infrastructure.Data.Models.Identity.ApplicationUser", "User")
                        .WithOne("RefreshToken")
                        .HasForeignKey("CarCare_Companion.Infrastructure.Data.Models.Identity.UserRefreshToken", "UserId")
