...
public interface ISearchService
{
    ...
    /// <param name="category">Optional. The category filter to narrow down the search results. If null, results from all categories are returned.</param>
    ...
    public Task<RecordsQueryModel> Search(string userId, string? category = null, string? searchTerm = null, RecordsSorting sorting = RecordsSorting.Newest, int currentPage = 1, int recordsPerPage = 1);
}
